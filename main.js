...
class Comment {
  constructor({ studentName, studentRole = "Estudiante", content }) {
...
const cursoPracticoHTML = new Course({
  ...
  classes: ["1. Introducción", "2. Práctico básico", "3. Práctico avanzado"],
  lang: "english",
});
...
const escuelaDesarrolloWeb = new LearningPaths({
  ...
  courses: [cursoProgBasica, cursoDefinitvoHTML, cursoPracticoHTML],
});
...
const miguelito = new BasicStudent({
  ...
  learningPaths: [escuelaDesarrolloWeb, escuelaDataScientist],
});
